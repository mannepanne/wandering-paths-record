...
- Enable picking up a project later and quickly understanding how everything works
- Communicate knowledge and expertise to others
- Ensure work is not lost when moving on to other projects
- Preferred output format: Markdown (.md)

## Documentation Analysis Areas

When creating documentation, focus on these areas:
