...
- [d1-setup.md](./d1-setup.md) — D1 database schema, API endpoints, local dev
- [auth-setup.md](./auth-setup.md) — Cloudflare Access + Google OAuth setup and JWT verification
...
- [ARCHIVE/supabase-setup.md](./ARCHIVE/supabase-setup.md) — Legacy Supabase setup (archived, pre-D1 migration)
